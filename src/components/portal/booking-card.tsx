...
export function BookingCard({ booking }: { booking: BookingSummary }) {
  ...
  return (
    <Link
      ...
      className="group block border border-vine-900/12 bg-stone-100 p-7 transition-colors hover:border-wine-600/40 sm:p-9"
    >
      ...
      <dl className="mt-7 grid gap-5 border-t border-vine-900/12 pt-6 sm:grid-cols-4">
        ...
        <div>
          ...
          <dd className="mt-1.5 text-[0.85rem] text-wine-600">
