...
const fieldBase =
  "w-full border border-vine-900/22 bg-sand-50 px-4 py-3.5 text-[0.95rem] text-vine-900 transition-colors placeholder:text-vine-400 focus:border-wine-600 focus:outline-none";
...
export function SubmitButton({
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className={`inline-flex items-center justify-center gap-2 bg-wine-600 px-8 py-4 text-[0.72rem] font-medium tracking-[0.2em] text-sand-50 uppercase transition-all duration-300 hover:bg-wine-700 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-wine-600 disabled:cursor-not-allowed disabled:opacity-60 ${className}`}
    >
